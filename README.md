...
Click here to watch our full project demo!
...
In this GitHub repository, open the /webgame folder.
...
Go to File → Open and select the Hackss folder you just unzipped.
